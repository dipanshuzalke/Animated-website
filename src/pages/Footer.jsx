...
const Footer = () => {
  return (
    <footer className="bg-white text-black px-4 md:px-0 py-20 border-t container">
      {/* Top Section */}
      <div className="flex flex-col md:flex-row justify-between items-start gap-6 md:gap-10">
        <div>
          <h4 className="font-bold text-lg tracking-wide mb-2">
        ...
        <div className="space-y-2 text-sm flex gap-6 md:gap-12">
      ...
      {/* Newsletter */}
      <div className="mt-10 md:mt-16 flex flex-col md:flex-row justify-between items-start gap-2 md:gap-10">
        <div>
        ...
        <div className="flex flex-col justify-center sm:flex-row items-center gap-4">
          ...
          />
          <button className="bg-lime-400 text-black w-full px-6 py-3 rounded-full hover:bg-lime-500 transition">
            SUBSCRIBE
          </button>
        </div>
      </div>
