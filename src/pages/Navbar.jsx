...
export default function ResponsiveNavbar() {
  ...
  return (
    <>
      ...
      <nav className="hidden lg:block bg-white/95 backdrop-blur-lg border-b border-gray-200 top-0 z-40">
          ...
          <div className="flex justify-between items-center h-20">
            ...
            <div className="relative language-dropdown">
              ...
              >
                ...
                <ChevronDown className={`w-5 h-5 transition-transform duration-300 ${isLangOpen ? 'rotate-180' : ''}`} />
              </button>
              {isLangOpen && (
                  ...
                  {languages.map((lang) => (
                    ...
                    >
                      <span className="flex items-center justify-between">
                        {lang.label}
                        {lang.active && <span className="w-2 h-2 bg-indigo-600 rounded-full"></span>}
                      </span>
                    </button>
                  ))}
                </div>
